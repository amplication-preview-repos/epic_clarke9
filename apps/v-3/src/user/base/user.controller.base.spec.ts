...
const CREATE_INPUT = {
  ...
  copyTradeMarket: "exampleCopyTradeMarket",
  copyTradeMarketUid: "exampleCopyTradeMarketUid",
  createdAt: new Date(),
  createdById: "exampleCreatedById",
  deviceId: "exampleDeviceId",
  email: "exampleEmail",
  emailValidationCode: "exampleEmailValidationCode",
  ...
  monthlyR: 42,
  monthlyRoi: "exampleMonthlyRoi",
  name: "exampleName",
  password: "examplePassword",
  phone: "examplePhone",
  rate: 42,
  registrationToken: "exampleRegistrationToken",
